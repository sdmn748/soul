...
TOKEN = '7515354967:AAHXmjAKBpDjoRoWXPSrwl7KoXCXfilR9VA'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002220761952
CHANNEL_ID = -1002220761952
error_channel_id = -1002220761952
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/bgmi_serverhacker/6*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin selected Dm= @Mk_ddos*", parse_mode='Markdown')
    else:
        bot.reply_to(message, "*@Mk_ddos*", parse_mode='Markdown')
